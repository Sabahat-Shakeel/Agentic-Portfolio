...
export default function AboutMe() {
  return (
    <section >
      ...
      <p className="text-start text-purple-400 text-lg leading-relaxed lg:p-4 "><CgQuote className="inline-block mb-3 text-md text-pink-500/80" />
        ...
        <CgQuote className="inline-block mt-2 text-md text-pink-500/80" /></p>
       </div>
      <TechStack/>
    </section>
  );
