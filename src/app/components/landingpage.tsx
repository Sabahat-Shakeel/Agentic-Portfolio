...
function HomePage() {
  return (
<div className="flex flex-col items-center justify-center  h-min bg-gradient-to-tr from-pink-500 via-black to-[#3cce3e] p-11 portrait:mt-24 sm:rounded-full shadow-2xl shadow-yellow-900 portrait:rounded-full ">
